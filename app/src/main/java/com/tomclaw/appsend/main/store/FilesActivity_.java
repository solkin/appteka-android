...
public final class FilesActivity_
    ...
    implements BeanHolder, HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        this.uploadsFragment = ((UploadsFragment) findSupportFragmentById(R.id.uploads_fragment));
        init();
    }
    ...
    private void injectExtras_() {
        ...
        if (extras_!= null) {
            if (extras_.containsKey(USER_ID_EXTRA)) {
                this.userId = ((Long) extras_.getSerializable(USER_ID_EXTRA));
            }
        }
    }
        ...
        extends ActivityIntentBuilder<IntentBuilder_>
    {
        ...
        public IntentBuilder_(Context context) {
            super(context, FilesActivity_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            super(fragment.getActivity(), FilesActivity_.class);
            fragment_ = fragment;
        }
