...
public final class AbuseActivity_
    extends AbuseActivity
    implements BeanHolder, HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        this.reasonGroup = hasViews.internalFindViewById(R.id.reason_group);
        this.emailInput = hasViews.internalFindViewById(R.id.input_email);
        init();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.abuse_menu, menu);
        ...
        extends ActivityIntentBuilder<IntentBuilder_>
    {
        ...
        public IntentBuilder_(android.app.Fragment fragment) {
            super(fragment.getActivity(), AbuseActivity_.class);
            fragment_ = fragment;
        }
