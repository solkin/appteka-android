...
public class UnlinkActivity extends AppCompatActivity {
    ...
    public static Intent createUnlinkActivityIntent(Context context, String appId, String label) {
        return UnlinkActivity_.intent(context).appId(appId).label(label).get();
    }
}
